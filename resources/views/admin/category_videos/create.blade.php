    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Thêm mới Danh mục videos</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 d-sm-flex justify-content-between align-items-center">
                            <h5 class="card-title">Tạo mới Danh mục videos</h5>
                        ...
                        <form action="{{ route('admin.category_videos.store') }}" method="POST" class="row g-3">
                            @csrf
